...
<c:if test="${param.showonly==true}">
    lalalalallaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
</c:if>

<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="${product.image}"></div>
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                ...
                <tr>
                    <td>月销量:13</td>
                    <td><span class="reviewProductInfoTableSellNumber">${product.salenumber}</span> 件</td>
                </tr>
            </table>
    ...
    <div class="reviewStasticsDiv">
        <div class="reviewStasticsLeft">
            ...
            <div class="reviewStasticsLeftContent">累计评价 <span
                    class="reviewStasticsNumber"> ${product.numberOfPeople}</span></div>
    ...
    <c:if test="${showonly==true}">
        <div class="reviewDivlistReviews">
            <c:forEach items="${reviews}" var="r">
                <div class="reviewDivlistReviewsEach">
                    <div class="reviewDate">${r.publicDate}</div>
