...
<div>
    <h2 style="font-family: 华文楷体;margin-left: 20px;margin-top: 10px">编辑子类</h2>
</div>

        <form action="/admin/updateCategoryClass">
            <input hidden name="id" value="${categoryclass.id}">
            <div class="layui-form-item">
                <label  class="layui-form-label">
                    子类名
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="category_className" name="categoryClassname" class="layui-input" value="${categoryclass.categoryClassname}">
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div>
                <select name="categoryId" style="height: 35px">
