        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('用户列表(静态表格)','/admin/listUser')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表(静态表格)</cite></a>
                    </li>
                  <%--  <li>
                        <a onclick="xadmin.add_tab('会员列表(动态表格)','admin/listUser1',true)">
                            <i class="iconfont">&#xe6a7;</i>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('订单列表','/admin/listOrder')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('多级分类','/admin/listCategory')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>多级分类</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('多级分类','/admin/listProduct_class')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>所有图书管理</cite></a>
                    </li>
                   <%-- <li>
