...
/**
	...
	float add(Order order, List<BookNew> orderItems, HttpSession session);
	float add1(Order order, List<OrderItem> orderItems);
	Integer getStatusNum(String s);
	int deleteOrderItem(int order_id);
