    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${order.orderItems}" var="oi">
                <tr>
                    <td><img width="50px" src="${oi.bookNew.image}" referrerpolicy="no-referrer"></td>
                    <td class="confirmPayOrderItemProductLink">
                        <a href="#nowhere">${oi.bookNew.bookname}</a>
                    </td>
                    <td>￥${oi.bookNew.price}</td>
                    <td>1</td>
                    <td><span class="conformPayProductPrice">￥${oi.bookNew.price}</span></td>
