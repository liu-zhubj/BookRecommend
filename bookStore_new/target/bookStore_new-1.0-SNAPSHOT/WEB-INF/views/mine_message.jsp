...
<div class="bj">
    ...
    <h3>编辑基础资料</h3>
    <form action="/update_mymessage" method="get">
        <p><label>姓名：</label><input type="text" id="name" name="name" value="${user.name}" /></p>
        <p><label>电话：</label><input type="text"  id="phone" name="phone" /></p>
        <p><label>年龄：</label><input type="text"  id="age" name="age" /></p>
        <p><label>邮件：</label><input type="text"  id="email" name="email" /></p>
        <p>
            <label>性别：</label>
...
<div class="xg">
    ...
    <form action="#" method="get">
        <p><label>姓名：</label><input type="text"  value="${user.name}" /></p>
        <div class="bc">
