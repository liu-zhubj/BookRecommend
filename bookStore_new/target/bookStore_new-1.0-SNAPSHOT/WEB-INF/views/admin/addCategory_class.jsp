...
<div>
    <h2 style="font-family: 华文楷体;margin-left: 20px;margin-top: 10px">编辑分类</h2>
</div>
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="/admin/addCategoryClass">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="" name="categoryId" class="layui-input" value="${id}">
                </div>
            </div>
            <div class="layui-form-item">
