                            ...
                            <div class="row col-lg-12">
                               &lt;%&ndash; <form role="form">&ndash;%&gt;
                                    <div class="form-group">
                                       ...
                                       <label>图片url：</label>
                                      <input type="text" name="bookname" class="form-control" value="${product.image}">
                                      &lt;%&ndash;  <a href="${product.image}">dd</a><img src="${product.image}">&ndash;%&gt;
    ...
    <div class="layui-row">
        <form class="layui-form" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="bookname" class="layui-input" value="${product.bookname}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="author" class="layui-input" value="${product.author}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="price" class="layui-input" value="${product.price}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="isbn" class="layui-input" value="${product.isbn}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="publicsource" class="layui-input" value="${product.publicsource}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="date" class="layui-input" value="${product.date}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="score" class="layui-input" value="${product.score}"  disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="pages" class="layui-input" value="${product.pages}"  disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="salenumber" class="layui-input" value="${product.salenumber}"  disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="storenumber" class="layui-input" value="${product.storenumber}"  disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <textarea type="text"  name="authorIntroduction" style="width:200px;height: 60px;background-color: white" disabled>${product.authorIntroduction}</textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <textarea  type="text"  name="bookinfo" style="width: 200px;height: 60px;background-color: white"  disabled>${product.bookinfo}</textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <textarea type="text"  name="label"  style="width: 200px;height: 60px;background-color: white"  disabled>${product.label}</textarea>
                </div>
            </div>
