...
//	订单页面  修改地址
   ...
   /* $("#del span").click(function(){
    ...
    $("a[orderStatus]").click(function () {
        ...
        if ('all' == orderStatus) {
            $(".dkuang").find("p[orderStatus]").parent(".dkuang").show();
        }
        else {
            $(".dkuang").find("p[orderStatus]").parent(".dkuang").hide();

            $(".dkuang").find("p[orderStatus=" + orderStatus + "]").parent(".dkuang").show();
        }
